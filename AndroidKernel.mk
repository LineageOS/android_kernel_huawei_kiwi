...
ifeq ($(CONFIG_EFS_ENLARGE_FEATURE),true)
KERNEL_CONFIG_OVERRIDE += CONFIG_EFS_ENLARGE_FEATURE=y
endif
...
$(TARGET_PREBUILT_INT_KERNEL): $(TARGET_PREBUILT_INT_KERNEL)_pre
	$(mv-modules)
	$(clean-module-folder)
$(TARGET_PREBUILT_INT_KERNEL)_pre: $(KERNEL_OUT) $(KERNEL_HEADERS_INSTALL) 
